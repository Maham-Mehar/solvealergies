            ...
            >
                ...
                <div className="hidden md:hidden lg:block">
                    <div className="flex items-center gap-[3rem] lg:gap-[3.5rem]">
                        <button onClick={() => handleClick("home")} className={`font-circular font-bold text-base ${activeLink === "home" ? "text-green" : "text-gray"
                            }`}>
                            Home
                        </button>
                        <button onClick={() => handleClick("feature")} className={`font-circular font-bold text-base ${activeLink === "feature" ? "text-green" : "text-gray"
                            }`}>
                            Features
                        </button>
                        <button onClick={() => handleClick("faqs")} className={`font-circular font-bold text-base ${activeLink === "faqs" ? "text-green" : "text-gray"
                            }`}>
                            FAQs
                        </button>
                        <button onClick={() => handleClick("contact")} className={`font-circular font-bold text-base ${activeLink === "contact" ? "text-green" : "text-gray"
                            }`}>
                            Contact
                        </button>
                    </div>
                    ...
                    <div
                        ...
                        <div className="space-y-7">
                            <div className="flex flex-col gap-[2rem] mt-10">
                                <button onClick={() => handleClick("home")} className={`font-circular font-bold text-base marker:text-start ${activeLink === "home" ? "text-green" : "text-gray"
                                    }`}>
                                    Home
                                </button>
                                <button onClick={() => handleClick("feature")} className={`font-circular font-bold text-base text-start ${activeLink === "feature" ? "text-green" : "text-gray"
                                    }`}>
                                    Features
                                </button>
                                <button onClick={() => handleClick("faqs")} className={`font-circular font-bold tex-tbase text-start ${activeLink === "faqs" ? "text-green" : "text-gray"
                                    }`}>
                                    FAQs
                                </button>
                                <button onClick={() => handleClick("contact")} className={`font-circular font-bold text-base text-start ${activeLink === "contact" ? "text-green" : "text-gray"
                                    }`}>
                                    Contact
                                </button>
                            </div>
