    ...
    return (
        <div className="container mx-auto mt-[8rem] sm:mt-[10rem] lg:mt-[12rem]" id="contact-section">
                ...
                <div className="container px-4 sm:px-16 xl:my-[80px]">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-[24px] mt-[34px]">
                        ...
                        <div className="flex justify-center mt-[24px]">
                            <button
                                type="submit"
                                className="bg-green rounded-full w-[230px] sm:w-[311px] h-[45px] sm:h-[56px] text-center font-bold text-white font-poppins"
                            >
                                Send Message
                            </button>
                        </div>
            ...
            <div className="flex justify-center xl:mt-[64px] lg:mt-[58px] md:mt-[52px] sm:mt-[46px] mt-[42px]">
                <button className="bg-text-gradient-green w-[270px] sm:w-[358px] h-[50px] sm:h-[56px] font-poppins font-bold text-lg sm:text-[24px] text-white rounded-full">
                    Get App Now
                </button>
            </div>
        </div>
